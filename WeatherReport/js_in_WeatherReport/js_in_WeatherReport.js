...
function updateBackground(weatherMain) {
    ...
    switch(weatherMain) {
        case 'Clear':
            backgroundUrl = 'url("\WeatherReport\images_in_WeatherReport\clear.webp")';
            break;
        case 'Clouds':
            backgroundUrl = 'url("\WeatherReport\images_in_WeatherReport\cloudy.jpg")';
            break;
        case 'Rain':
            backgroundUrl = 'url("\WeatherReport\images_in_WeatherReport\rainy.webp")';
            break;
        case 'Snow':
            backgroundUrl = 'url("\WeatherReport\images_in_WeatherReport\snow.avif")';
            break;
        case 'Thunderstorm':
            backgroundUrl = 'url("\WeatherReport\images_in_WeatherReport\thunderstorm.webp")';
            break;
        case 'Drizzle':
            backgroundUrl = 'url("\WeatherReport\images_in_WeatherReport\drizzle.jpg")';
            break;
        case 'Mist':
            backgroundUrl = 'url("\WeatherReport\images_in_WeatherReport\misty.webp")';
            break;
        default:
            backgroundUrl = 'url("\WeatherReport\images_in_WeatherReport\default.avif")';
            break;
    }
